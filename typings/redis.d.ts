...
export interface Commands<R> {
    ...
    json_del(key: string, path: string): string;
    DEL: OverloadedCommand<string, number, R>;
    delAsync(key: string, path: string): Promise<0 | 1>
    ...
    getAsync(key: string, path?: string): Promise<string | null>
     ...
     */
    json_set(key: string, path: string, json: string): string
    setAsync(key: string, path: string, json: string): Promise<string>
